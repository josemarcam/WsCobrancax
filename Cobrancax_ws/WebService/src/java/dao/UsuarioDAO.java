 ...
 */
    ...
    {
         String sql = "SELECT * FROM sis_usuarios where us_us=? AND us_senha=?";
        ...
        try {
            ...
            {
                retorno = new Usuario();
                retorno.setLogin(res.getString("us_us"));
                retorno.setSenha(res.getString("us_senha"));
                retorno.setEmail(res.getString("us_email"));
                retorno.setId(res.getInt("us_id"));
